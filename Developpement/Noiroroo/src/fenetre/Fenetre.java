...
import panneau.Background;
import panneau.PanneauClass;
import panneau.PanneauCompetence;
import panneau.PanneauPersonnage;
...
public class Fenetre extends JFrame{
	...
	public Fenetre() {
		...
		PanneauRace race = new PanneauRace("Portraits/ArmandeConcept.png",new Dimension(-1+width/3,-1+2*heigth/3), false );
